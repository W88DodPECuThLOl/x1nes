#ifndef INCL_cpu6502_h
#define INCL_cpu6502_h
...
//    u64 t_cycles;
    ...
    u16 sub_address; // subroutine address
    u16 dma_cycles;
    u8 sr_started; // subroutine started
    u8 ac;
    u8 x;
    u8 y;
    u8 sr;
    ...
    u8 cycles;
    u8 odd_cycle;
    u8 mode; // Mode of execution. Use set_spu_mode to set
    struct Emulator* emulator;
    u8 state;  // Internal implementation state. See above
    Interrupt interrupt;
    u8 NMI_line;
